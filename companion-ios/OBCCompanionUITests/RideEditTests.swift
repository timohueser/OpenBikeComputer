...
/// the Furka: the merge suggestion, edit mode with the shared handles, split, revert and merge.
...
final class RideEditTests: XCTestCase {
    ...
    @MainActor
    func testSplitRevertAndMergeADayWithTwoRides() {
        ...
        // Edit mode: trim first, then split halfway.
