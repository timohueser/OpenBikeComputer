...
impl HomeScreen {
        ...
        F: Fn(u16) -> D::Color,
    {
        ...
        cv.text("HOME", Point::new(w / 2, h / 2 - 14), Font::Display, TextAlign::Center, palette::AMBER);
        cv.text("press to start", Point::new(w / 2, h / 2 + 12), Font::Label, TextAlign::Center, palette::PARCHMENT);
        RenderStats::default()
    }
}
