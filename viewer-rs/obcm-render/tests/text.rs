//! Smoke tests for the shared text primitive ([`obcm_render::text`]). Mirrors
...
use obcm_reader::{rgb565_to_device64, rgb565_to_rgb888};
use obcm_render::text::{draw_text, text_width, Font, TextAlign};
