...
//! `for_each_chunk_has_no_cap` in `obcm-reader/tests/format.rs`) cover decoding,
...
use obcm_render::{MapRenderer, Viewport, MAX_SPANS};
...
// ---------------------------------------------------------------------------
// Byte builders (mirror obcm-reader/tests/format.rs / serialize.py).
// ---------------------------------------------------------------------------
