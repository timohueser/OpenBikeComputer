...
python3 ops/weather/freshness_probe.py --url https://wx.openbikecomputer.com --v2
```

Exit codes: `0` fresh, `1` stale / missing / over budget, `2` unreachable.

`--v2` probes the canonical sharded dataset at `wx/v2/manifest.json` instead of the v1 product list
