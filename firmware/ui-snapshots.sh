...
"$SIM" "$MAP" --boot --peak-view gornergrat --script "B d d d d p f d" --expect-screen PeakView --png "$OUT/peak-view-browse.png"
...
# Matterhorn selected after two Browse steps. Generic labels are selection-independent:
