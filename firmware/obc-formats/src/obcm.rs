...
/// Style-record flag bit 6 (§2): **ticked** line — a solid stroke carrying regular perpendicular
/// ticks, the cableway and lift mark. Written with [`STYLE_DASHED_BIT`] clear; a record that sets
