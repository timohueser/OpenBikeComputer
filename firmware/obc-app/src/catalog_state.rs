...
impl CatalogState {
    ...
    pub(crate) unsafe fn init_in_place(slot: *mut Self) {
        ...
        unsafe {
            ...
            addr_of_mut!((*slot).source_revision).write(Revision::ZERO);
            addr_of_mut!((*slot).ride_track_view).write(Revision::ZERO);
            addr_of_mut!((*slot).nav_preview_view).write(Revision::ZERO);
