...
Each file is a 160 × 120 row-major image, one RGB222 byte per pixel: `00_RR_GG_BB`.
Each channel has levels 0, 85, 170, and 255. Each file is 19,200 bytes. There is no header,
...
are the small ordered 4 × 4 samples in the [photo study](../../../../docs/assets/ride-assistant/landmark-photos/README.md).
