...
- **eg join quality.** At casing widths (5–7 px) embedded-graphics `Polyline` miter spikes get more
  ...
  ([lib.rs:490](../obc-render/src/lib.rs#L490)). If junctions look ragged, hand-roll the stroke as
  quad + disc per segment for round joins (the [`arm`/`chevron`](../obc-app/src/screen/map.rs#L325)
