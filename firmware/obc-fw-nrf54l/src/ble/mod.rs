...
//! ## Module map
//!
//! This file is the stack bring-up + the S0 advertise → connect → re-advertise orchestration
//! ([`run`]); the four jobs the link does are split into focused submodules (issue #310):
//!
