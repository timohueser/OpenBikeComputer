...
//! time. Today it holds **L1 ([#141]): the free-running COM driver**. L2–L4 add the
//! gate-scan / source-shift primitives here. See `firmware/docs/ls021-bringup.md` for
//! the normative protocol/timing spec this is written against.
//!
//! ## COM driver ([`com_task`])
//!
