/* nRF54L15 (nRF54L15-DK), `nrf54l15-app-s` secure-app core.
   ...
   128K for its FLPR coprocessor demo; we reclaim all of it: the ST7789 display path
   runs on the M33 via SPIM-DMA (#122), and the FLPR is a deferred future epic. When the
   FLPR or a BLE controller lands they carve out their own region here. The renderer
   scratch + caches are tight against this 256K — the board memory profile + budget
   assert is #124. */
MEMORY
{
