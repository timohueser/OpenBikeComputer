...
//! | [`SideloadIdRegistry`] | session-stable ids for side-loaded FAT filenames without durable ids | `embedded-sdmmc` |
...
pub use sideload_id::{SideloadIdRegistry, SIDELOAD_ID_BASE};
