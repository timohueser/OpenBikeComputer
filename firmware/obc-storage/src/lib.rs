...
//!
//! [`flat`] is the raw-card store: the whole card format and the five-operation `Store` seam over a
//! 512-byte block device, with no partition table and no filesystem. [`sd`] is the FatFs
