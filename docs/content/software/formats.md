...
- The Device Object System v2 suite, normative for the wire-major-3 cutover these formats cross next: [`Device_Object_System_v2.md`](src:specs/Device_Object_System_v2.md) (the index) · [`Device_Object_Protocol_v3.md`](src:specs/Device_Object_Protocol_v3.md) (control and stream bytes) · [`OBC2_Storage_Format.md`](src:specs/OBC2_Storage_Format.md) (the on-card layout) · [`Device_Object_Registries_v2.md`](src:specs/Device_Object_Registries_v2.md) (object kinds and bounded domain schemas)
