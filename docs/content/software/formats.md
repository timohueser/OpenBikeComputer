...
- **One core file** carries the style table, the single unified navigation graph, the POIs, and the coarsest LODs. Routing therefore never crosses a file, and the router is untouched.
