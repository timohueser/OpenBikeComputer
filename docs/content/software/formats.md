...
The projection above deliberately still prices the old shape: over-estimating is the safe direction for a threshold whose job is to refuse, and it moves when there is a measurement to move it to.
