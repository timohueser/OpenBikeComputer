...
This page is the protocol — conceptual model first, then the mechanical detail and the signal reference. The firmware that implements it lives in [`obc-fw-nrf54l/src/ls021.rs`](src:firmware/obc-fw-nrf54l/src/ls021.rs).
...
- The M33-direct driver primitives (COM waveform, the gate/source bit-bang, `fill_solid`): [`obc-fw-nrf54l/src/ls021.rs`](src:firmware/obc-fw-nrf54l/src/ls021.rs)
