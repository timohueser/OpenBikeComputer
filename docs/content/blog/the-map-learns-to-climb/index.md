...
date: 2026-08-03
description: Elevation, end to end — a terrain raster carried beside the map, two new bytes in the routing graph, and the phantom-ascent bug that nearly shipped 1,412 metres of climbing that wasn't there.
---
