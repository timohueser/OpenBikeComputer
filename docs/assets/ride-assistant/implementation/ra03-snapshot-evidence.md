# RA03 CI snapshot evidence

[CI run 34955214991](https://github.com/timohueser/OpenBikeComputer/actions/runs/34955214991) at
`983a600f` produced 259 frames in artifact `ui-snapshots-1` (ID `10391636148`). The only failed
test-job step was the snapshot manifest check: 14 changed frames, no missing or extra frames.
Manifest commit `7c7f418c` records hashes calculated from this run's downloaded PNG files.
