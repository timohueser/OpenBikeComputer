...
| --- | --- | --- |
| ![Reichenbach Falls description](falls.png) | ![Fictional Holmes and Moriarty connection](falls-facts.png) | ![Wikipedia attribution and unknown hours](source.png) |
...
selected landmark. **Visit** opens the shared route preview. **Add stop** accepts the complete
...
No photographs are included. A later study could preconvert a small image during map creation
and store palette pixels. For example, 160 × 90 at one byte per pixel is 14,400 bytes before
