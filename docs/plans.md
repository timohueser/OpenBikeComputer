...
Use current package READMEs and [architecture](content/software/architecture.md) for behavior.
These records explain work still in progress. GitHub issues track completion; verify their current
state before starting a task. See [the lifecycle](README.md#current-guidance-and-implementation-history).
...
are complete, and mark the linked handoff historical. Keep small changes in their PR.
