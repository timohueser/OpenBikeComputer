<script lang="ts">
  ...
  let view: 'requirements' | 'coverage' | 'releases' | 'account' = 'requirements';
  let previousView: 'requirements' | 'coverage' | 'releases' = 'requirements';
