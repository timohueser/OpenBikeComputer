...
# tiny — hand-authored XML -> pbf. The committed tiny/tiny.osm is the source of
# truth; the .pbf is git-ignored and rebuilt here for the obc-pack ingest test
# (firmware/obc-pack `ingest::tests::tiny_truth_table`).
echo ">> tiny"
