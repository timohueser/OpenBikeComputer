"""Entry point: `python -m packer.web_builder` launches the server and opens a browser."""
import argparse
import threading
import webbrowser
...
def main():
    ...
    uvicorn.run("packer.web_builder.server:app", host=args.host, port=args.port, log_level="info")
