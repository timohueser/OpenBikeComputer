...
pub(crate) struct CellSidecar {
    ...
    /// The terrain revision this cell's nav ascents were integrated from. Skipped when absent so a
    /// terrain-less tree's sidecars stay byte-identical to the ones baked before terrain existed.
