"""Entry point: `python -m builder.server` launches the server and opens a browser."""
import argparse
import threading
import webbrowser
...
def main():
    ...
    uvicorn.run("builder.server.server:app", host=args.host, port=args.port, log_level="info")
